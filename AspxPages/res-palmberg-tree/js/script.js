...
function myfunc_palmberg_tree(data)
{
    ...
    node
      // Show only one circle for Mary
          .style('display', function (d) {
              ...
              } else if (d['name'] === topparent && d['depth'] === 4) {
                  count_mary_two += 1;
...
{
    myfunc_palmberg_tree(tree_data);
}
